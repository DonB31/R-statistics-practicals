...
Si difference positive : exces d'effectifs , col resisteent , ws S et Can s. 
si negatif : deficit d'effectifs 

**Conclusion :** La resistance est dépendante de l'ecotype mais particuliermeent pour l'ecotype Col. 
...
avec greater , on voit uqe la p value est inferieure a 0.05 donc la moyenne de Col_0 est superieure a la moyenne de Mut_X1. 
